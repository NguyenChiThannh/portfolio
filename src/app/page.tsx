...
const frontend: SkillItem[] = [
  ...
  {
    name: 'TanStack Query',
    icon: 'https://i.imgur.com/Kqxbl5Q.png',
  },
]
...
const backend: SkillItem[] = [
  {
    name: 'Golang-Kratos',
    icon: 'https://miro.medium.com/v2/resize:fit:740/1*8MxzHkSAWKZGnsSFMAMP7A.png',
  },
  {
    name: 'Golang-Fiber',
    icon: 'https://miro.medium.com/v2/resize:fit:1400/1*A-EA3uxS16IhYDrr0dQ-6w.png',
  },
  {
    name: 'Node.js',
  ...
  {
    name: 'Elasticsearch',
    icon: 'https://miro.medium.com/v2/resize:fit:2000/1*DfBbVqPXfIXGFQCa1BrV8g.jpeg',
  },
  {
    name: 'Microservices',
    icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGkojz_5BWJilJqZ-4zZN3zPlS4e1TuBBVEQ&s',
  },
  {
    name: 'Docker',
...
const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Trello',
    description:
      'Trello is an online project management tool based on a board and card system.',
    longDescription:
      'Trello is an online project management tool based on a board and card system.',
    image: '/project2.png',
    technologies: [
    ...
    codeLink: [
      'https://github.com/NguyenChiThannh/Trello-apis',
      'https://github.com/NguyenChiThannh/Trello',
    ],
    demoLink: '',
  ...
  },
  {
    ...
    title: 'MIF- Nextjs',
    description:
      'MIF is a forum for film enthusiasts. The application allowing users to join groups, post articles, engage with film content, and message within groups. ',
    longDescription:
      'MIF is a forum for film enthusiasts. The application allowing users to join groups, post articles, engage with film content, and message within groups. It provides detailed information about movies and actors, along with features for rating and saving films, as well as favoriting artists',
    image: '/project3.png',
    technologies: [
      'Javascript',
      'NextJS',
    ...
    demoLink: 'https://mif-nextjs-sage.vercel.app/',
  ...
  },
  {
    ...
    longDescription:
      'CISNW is a music player application on the Android platform that allows users to listen to music, create playlists, and share music with friends. The app provides a user-friendly interface with features for searching, playing, and organizing music.',
    image: '/project4.png',
    ...
    codeLink: [
      'https://github.com/NguyenChiThannh/music_app_backend',
      'https://github.com/NguyenChiThannh/music_app',
    ],
    demoLink: '',
...
export default function Home() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground'>
          ...
          >
            <div className='md:w-1/2 space-y-4'>
              ...
              <div className='flex space-x-4 pt-8'>
                <Link
                  href='https://www.linkedin.com/in/nguyenchithannh/'
                  className='text-muted-foreground hover:text-primary transition-colors'
                >
                  <Linkedin size={20} />
                </Link>
                <Link
                  href='https://github.com/NguyenChiThannh'
                  className='text-muted-foreground hover:text-primary transition-colors'
                >
                  <Github size={20} />
                </Link>
                <Link
                  href='mailto:thanh.161003@gmail.com'
                  className='text-muted-foreground hover:text-primary transition-colors'
                >
                  <Mail size={20} />
                </Link>
            ...
            <div className='md:w-1/2 flex justify-center mt-10 md:mt-0'>
              <div className='relative w-64 h-64 md:w-80 md:h-80 mx-auto'>
                ...
                <div
                  className='absolute -bottom-2 -left-2 w-8 h-8 rounded-full bg-secondary/20 animate-pulse'
                ...
                {/* Subtle ring effect */}
                <div
                  className='absolute -inset-2 rounded-full border border-primary/10 animate-pulse'
      ...
      <section
        id='about'
        className='container mx-auto px-4 py-16 bg-secondary/5'
      >
        <ScrollReveal delay={0.2} className='max-w-4xl mx-auto'>
          ...
          <div className='mt-8 space-y-6 text-muted-foreground'>
            <p className='leading-relaxed'>
              I have a strong foundation in design and frontend development,
              allowing me to create visually appealing and user-friendly
              interfaces. Additionally, I have experience in backend development
              and enjoy working with databases, APIs, and server-side logic. I
              am also passionate about learning and exploring system
              architecture to better understand how different components of an
              application interact and scale efficiently.
            </p>
            <p className='leading-relaxed'>
              My goal over the next three years is to enhance my skills in both
              frontend and backend technologies, deepen my knowledge of software
              architecture, and ultimately become a proficient full-stack
              developer.
            </p>
          </div>
      ...
      <section id='skills' className='container mx-auto px-4 py-16'>
        <div className='max-w-6xl mx-auto'>
          ...
          >
            <Badge variant='outline' className='mb-2 mx-auto block w-fit'>
              My Expertise
            </Badge>
            ...
            <div className='space-y-12'>
              ...
              >
                ...
                <p className='text-muted-foreground mt-3'>
                  Developed REST/gRPC APIs using Golang (Kratos, Fiber) in a
                  microservices architecture.
                </p>
                <p className='text-muted-foreground mt-3'>
                  Integrated Kafka (event-driven), Redis (caching/pubsub), and
                  Elasticsearch (advanced search).
                </p>
                <p className='text-muted-foreground mt-3'>
                  Optimized system performance, conducted code reviews, and
                  supported operations.
                </p>
                <div className='flex flex-wrap gap-2 mt-4'>
                  <Badge variant='secondary'>Golang</Badge>
                  <Badge variant='secondary'>Fiber</Badge>
                  <Badge variant='secondary'>Kratos</Badge>
              ...
              >
                ...
                <p className='italic text-sm'>
                  GPA: <strong>3.54 / 4</strong>
                </p>
                <p className='text-muted-foreground mt-3'>
                  Graduated with a degree in Software Engineering, specializing
                  in web development and modern technologies. Experienced in
                  building full-stack web applications using React.js and
                  Node.js, designing responsive user interfaces, and optimizing
                  performance. Passionate about clean code, problem-solving, and
                  continuously learning through real-world projects and
        ...
        <div className='max-w-6xl mx-auto'>
          <ScrollReveal delay={0.2}>
            ...
            <p className='text-center text-muted-foreground mb-10 max-w-2xl mx-auto'>
              A collection of my UI/UX design work. Click on any design to view
              my complete portfolio on Behance.
            </p>
